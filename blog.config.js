...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Wilon', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '创业团长 Managing Partner at Wonder Seed Incubator', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.wilonvives.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, blog, wilon, incubator', // 网站关键词 英文逗号隔开
